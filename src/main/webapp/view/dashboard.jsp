			...
			<div class="col-lg-3 col-md-4 col-12 sidebar">
				<ul class="dropdown">
					...
					<li>Course
						<ul class="submenu">
							<li><a
								href="${pageContext.request.contextPath }/admin/newCourse">New
									Course</a></li>
							<li><a
								href="${pageContext.request.contextPath }/admin/viewAllCourse">View
									Course</a></li>
						</ul>
					</li>
				...
				<ul class="dropdown">
					<li>Chapter
						<ul class="submenu">
							<li><a
								href="${pageContext.request.contextPath}/admin/newChapter">New
									Chapter</a></li>
							<li><a
								href="${pageContext.request.contextPath}/admin/viewChapter">View
									Chapter</a></li>
						</ul>
				...
				<ul class="dropdown">
					<li>Topic
						<ul class="submenu">
							<li><a
								href="${pageContext.request.contextPath}/admin/newTopic">New
									Topic</a></li>
							<li><a
				...
				<ul class="dropdown">
					<li>Video
						<ul class="submenu">
							<li><a
								href="${pageContext.request.contextPath}/admin/newVideo">New
									Video</a></li>
							<li><a
								href="${pageContext.request.contextPath}/admin/viewVideos">View
									Videos</a></li>
						</ul>
				...
				<ul class="dropdown">
					<li>Faculty
						<ul class="submenu">
							<li><a
								href="${pageContext.request.contextPath}/admin/newFaculty">New
