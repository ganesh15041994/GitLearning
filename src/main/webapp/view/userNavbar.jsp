...
<nav
	...
	<div class="collapse navbar-collapse " id="navbarCollapse">
		<div class="navbar-nav ms-auto p-4 p-lg-0">
			<a href="index.html" class="#">Home</a> <a
				href="about.html" class="#">About</a> <a
				href="courses.html" class="#">My Courses</a>
			<div class="nav-item dropdown">
				<a href="#" class="nav-link dropdown-toggle"
					data-bs-toggle="dropdown">My Videos</a>
				<div class="dropdown-menu fade-down m-0">
					<a href="#" class="dropdown-item">My Progress</a> <a
						href="#l" class="dropdown-item">Testimonial</a> <a
						href="#" class="dropdown-item">404 Page</a>
				</div>
			</div>
			<a href="#" class="nav-item nav-link">My Profile</a>
		</div>
		<a href="${pageContext.request.contextPath }/logout"
			class="mycls text-white py-3 px-lg-5 d-none d-lg-block">Log Out<i
